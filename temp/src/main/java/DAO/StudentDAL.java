...
public class StudentDAL extends DatabaseManager {
    ...
    public ArrayList ReadStudents() throws SQLException {
        ...
        while (rs.next()) {
            Student s = new Student(rs.getInt("PersonID"), rs.getString("Lastname"), rs.getString("Firstname"), Timestamp.valueOf(rs.getString("EnrollmentDate")));
            array.add(s);
        }
        return array;
    }
...
//                    st.setEnrollmentDate(Timestamp.valueOf(sc.nextLine()));
